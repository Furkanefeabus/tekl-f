...
# Railway'de .env dosyası olmayabilir, o yüzden hata vermeden yükle
env_file = ROOT_DIR / '.env'
if env_file.exists():
    load_dotenv(env_file)

# Supabase bağlantısı - Environment variables'dan oku
...
# CORS - Netlify ve tüm originlere izin ver
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://bartesteklif.netlify.app",
        "https://*.netlify.app",
        "http://localhost:3000",
        "http://localhost:8081",
        "*"
