...
const AddProduct = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log('✅ Ürün başarıyla kaydedildi:', response.data);
      
      // Başarı mesajı göster ve Ürünler sayfasına git
      ...
      Alert.alert(
        'Hata',
        error.response?.data?.detail || error.message || 'Ürün eklenemedi. Lütfen tekrar deneyin.'
      );
    } finally {
      setLoading(false);
    }
